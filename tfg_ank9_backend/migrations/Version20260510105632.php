 ...
 */
final class Version20260510105632 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE gallery CHANGE dog_id dog_id INT DEFAULT NULL');
    }
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE gallery CHANGE dog_id dog_id INT NOT NULL');
    }
}
