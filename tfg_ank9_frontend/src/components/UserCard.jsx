...
export default function UserCard({user, onClickDelete, OnClickEdit, onClickDogs}) {
  return (
    <tr className='border'>
      ...
      <td>
        <div className="flex justify-center items-center gap-2">
            ...
            {
              user.dogs.length > 0 && (
                <button className='w-9 h-9 text-[#23374f] hover:text-white cursor-pointer' onClick={() => onClickDogs(user)}>
                  <svg xmlns="http://www.w3.org/2000/svg" width="full" height="full" viewBox="0 0 24 24">
