...
export default function AddButton({children, add}) {
  return (
    <div className='border rounded-2xl border-white text-white mx-2 flex justify-center'>
        <button className='m-2 rounded cursor-pointer group flex items-center gap-3' onClick={add}>
